    ...
    <div class="horizontal-main-wrapper">
            ...
            <div class="container">
                <div class="row my-4">
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="text-center">PROMO PENAWARAN MENARIK!</h2>
                            </div>
                        </div>
                        <?php 
                        if(isset($_SESSION['successy'])){
                            ...
                            echo '<div class="alert alert-warning my-4">'.$_SESSION['warning'].'</div>';
                    ...
                    <?php foreach($crm->getPromo() as $data){ ?>
                        <div class="col-md-4">
                            ...
                            <div class="card-header bg-primary text-white"><h3><?= $data['nama_promo']; ?></h3></div>
                                <div class="card-body">
                                    <p><?= $data['deskripsi_promo'] ?></p><br>
                                    <a data-toggle="modal" data-target="#exampleModalLongy<?= $data['id_promo'] ?>" href="#" class="btn btn-primary text-center"><i class="fa fa-like"></i> TERTARIK & AMBIL</a>
                                </div>
                                <div class="card-footer bg-primary">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="text-white"><i class="fa fa-calendar"></i> <?= date('d F Y', strtotime($data['dari_tgl'])) ?> - <?= date('d F Y', strtotime($data['sampai_tgl'])) ?> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row my-4">
                    ...
                    <?php foreach($crm->getProduct() as $data){ ?>
                        <div class="col-md-4" style="margin-bottom: 80px;">
                            ...
                            <div class="card-header bg-primary text-white"><h3><?= $data['nama_produk']; ?></h3></div>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <img style="height:120px;width:150px;" class="img-fluid img-thumbnail" src="assets/foto/<?= $data['foto_produk'] ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <p> 
                                    ...
                                    <a data-toggle="modal" data-target="#exampleModalLongx<?= $data['id_produk'] ?>" href="#" class="btn btn-primary text-center"><i class="fa fa-like"></i> TARIK & AMBIL PRODUK</a>
                                </div>
                                <div class="card-footer bg-primary">
                                    <p class="text-white"><i class="fa fa-dollar"></i> <?= "Rp. ". number_format($data['harga_produk'],0,'.','.'); ?> </p>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
        ...
        <footer>
            <div class="footer-area">
                <p>© Yohanis Karmoi 2024. projec by <a href="https://yohaniskarmoi123@gmail.com/wp/">anis_jr</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="controller/Data_crm.php?action=kirim_minat&id=<?= $data['id_produk']; ?>" method="POST">
    ...
    <?php foreach($crm->getPromo() as $data){ ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="controller/Data_crm.php?action=kirim_minat_promo&id=<?= $data['id_promo']; ?>" method="POST">
                        <label>Nama Lengkap</label>
                        <input type="text" name="nama" class="form-control" placeholder="Nama lengkap anda..."><br>
                        <label>Nomor Handphone</label>
                        <input type="text" name="no_hp" class="form-control" placeholder="Nomor handphone anda...">
